...
<div class="header">
    <ul class="navbar-nav" style="color: Background">
        <li class="nav-item active" style="position: absolute; left: 30px; top: 15px">
            <a class="nav-link" href="${pageContext.request.contextPath}/" style="color: white">Home</a>
        </li>
        <li class="nav-item active" style="position: absolute; right: 180px; top: 15px">
            <a class="nav-link" href="${pageContext.request.contextPath}/registration" style="color: white">Sign up</a>
        </li>
        <li class="nav-item active" style="position: absolute; right: 30px; top: 15px">
            <a class="nav-link" href="${pageContext.request.contextPath}/cart/products" style="color: white">Basket</a>
        </li>
    </ul>
</div>
</body>
